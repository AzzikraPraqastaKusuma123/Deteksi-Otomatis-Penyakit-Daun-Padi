...
function ManageAgriculturalResources() {
  ...
  return (
    <div className="agrius-resource-list-container">
      <div className="agrius-resource-list-header">
      ...
      <table className="agrius-resources-table">
        <thead>
          <tr>
            <th>Gambar</th>
            <th>Nama</th>
        ...
        <tbody>
          {resources.map(resource => (
            <tr key={resource.id}>
              ...
              <td className="agrius-resource-actions">
